    ...
    render() {
        ...
        return (
            <div>
                ...
                >
                    <div style={{ display: 'flex', flexDirection: 'column', backgroundColor: "#fff", borderRadius: 10, width: 400, padding: 20 }}>
                            ...
                            <Card sx={{ width: 250, maxWidth: 345, margin: 5, display: 'inline-block' }} >
                                ...
                                <CardActions>
                                    ...
                                    <Button size="small" onClick={() => {
                                        this.setState({ loader: true });
                                        this.props.deleteUser({ id: user.id }).then(this.setState({ loader: false }))
                                    }}>Delete</Button>
                                </CardActions>
                            </Card>
                        ))}
